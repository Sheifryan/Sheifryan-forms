...
export function Integrations() {
  return (
    <section id="integrations" className="scroll-mt-20 border-y border-line bg-white py-16 sm:py-20 dark:border-lineDark dark:bg-panelDark">
      <div className="mx-auto max-w-6xl px-5">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 font-body text-[14.5px] leading-relaxed text-slate-600 dark:text-mutedDark">
            Your form shouldn&apos;t be the end of the process. Send every submission on to the tools
            ...
            <Fragment key={step.title}>
              <StaggerItem className="flex-1">
                <div className="h-full rounded-xl border border-line bg-paper p-4 dark:border-lineDark dark:bg-night/40">
                  ...
                  <h3 className="mt-3 font-display text-[13.5px] font-bold text-ink dark:text-inkDark">
                    {step.title}
                  </h3>
        ...
        <Reveal className="mt-8" delay={0.05}>
          ...
          <p className="mt-4 text-center font-body text-[12px] text-slate-400 dark:text-mutedDark">
            Payment collection is available where MarzPay is configured, so forms can do more than
            gather information.
          </p>
        </Reveal>
      </div>
